Vue.component("v-btn",{
  ...
  template: "<div style='display:inline-block'>\
    <button class='btn' :class='bindClass' @click='onClick' @mouseenter='showBg1' @mouseleave='showBg2'><slot></slot></button>\
  </div>",
  // 具名插槽
  // template: "<div style='display:inline-block'>\
  //   <button class='btn' :class='bindClass' @click='onClick' @mouseenter='showBg1' @mouseleave='showBg2'><slot name ='title'></slot></button>\
  // </div>",
  data: function() {
    return{
      backColor: ''
